...
CREATE TABLE "tag" (
    ...
    "name" text NOT NULL,
    "image" text NOT NULL DEFAULT 'default.jpg'::text,
    "createdAt" timestamp without time zone NOT NULL,
    "updatedAt" timestamp without time zone NOT NULL,
    "_userTagsUserId" bigint
);
...
CREATE TABLE "user" (
    ...
    "createdAt" timestamp without time zone NOT NULL,
    "updatedAt" timestamp without time zone NOT NULL,
    "_tagUsersTagId" bigint
);

--
-- Class UserTag as table user_tags
--
...
--
-- Foreign relations for "tag" table
--
...
--
-- Foreign relations for "user_tags" table
--
